...
--
-- Хост: localhost
-- Время создания: Дек 02 2013 г., 00:07
...
--
-- Структура таблицы `diyk8_assets`
--

CREATE TABLE IF NOT EXISTS `diyk8_assets` (
...
--
-- Дамп данных таблицы `diyk8_assets`
--

INSERT INTO `diyk8_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(8, 1, 21, 58, 1, 'com_content', 'com_content', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
...
(27, 8, 22, 25, 2, 'com_content.category.2', 'Uncategorised', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
...
(34, 27, 23, 24, 3, 'com_content.article.1', 'Джумла.алмужД', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(35, 8, 26, 35, 2, 'com_content.category.8', 'Програмирование', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(36, 8, 36, 45, 2, 'com_content.category.9', 'Крым. Бухта Ласпи.', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(37, 8, 46, 57, 2, 'com_content.category.10', 'Туризм', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(38, 35, 29, 30, 3, 'com_content.article.2', 'Курс Advanced PHP', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(39, 35, 27, 28, 3, 'com_content.article.3', 'Курс Advanced CMS', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(40, 35, 31, 32, 3, 'com_content.article.4', 'Курс Frontend CMS', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(41, 36, 43, 44, 3, 'com_content.article.5', 'Что такое бухта Ласпи.', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(42, 36, 41, 42, 3, 'com_content.article.6', 'Как добраться в бухту Ласпи.               ', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(43, 36, 37, 38, 3, 'com_content.article.7', 'Достопримечательности Крыма, Форосская церковь.', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(44, 37, 47, 48, 3, 'com_content.article.8', 'Если вы упали в холодную воду.', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(45, 37, 55, 56, 3, 'com_content.article.9', 'Хлеб из желудей', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(46, 37, 53, 54, 3, 'com_content.article.10', 'Самодельная горелка из алюминиевых банок из под пива.', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(47, 37, 49, 50, 3, 'com_content.article.11', 'Как выбрать спальный мешок.', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(48, 37, 51, 52, 3, 'com_content.article.12', 'Как не промокнуть в походе.', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(49, 36, 39, 40, 3, 'com_content.article.13', 'Достопримечательности Крыма, Херсонес.', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(50, 35, 33, 34, 3, 'com_content.article.14', 'Курс Ruby on Rails.', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(51, 3, 6, 7, 2, 'com_banners.category.11', 'Ссылка туризм', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(52, 3, 8, 9, 2, 'com_banners.category.12', 'Ссылка ласпи.', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(53, 1, 103, 104, 1, 'com_blog_calendar', 'blog_calendar', '{}'),
(54, 1, 105, 106, 1, 'com_djmediatools', 'com_djmediatools', '{"core.admin":[],"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(69, 1, 107, 108, 1, 'com_homework6', 'com_homework6', '{}');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_associations`
--

CREATE TABLE IF NOT EXISTS `diyk8_associations` (
...
--
-- Структура таблицы `diyk8_banner_clients`
--

CREATE TABLE IF NOT EXISTS `diyk8_banner_clients` (
...
--
-- Структура таблицы `diyk8_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `diyk8_banner_tracks` (
...
--
-- Структура таблицы `diyk8_banners`
--

CREATE TABLE IF NOT EXISTS `diyk8_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `diyk8_banners`
--

INSERT INTO `diyk8_banners` (`id`, `cid`, `type`, `name`, `alias`, `imptotal`, `impmade`, `clicks`, `clickurl`, `state`, `catid`, `description`, `custombannercode`, `sticky`, `ordering`, `metakey`, `params`, `own_prefix`, `metakey_prefix`, `purchase_type`, `track_clicks`, `track_impressions`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `reset`, `created`, `language`) VALUES
(1, 0, 0, 'Более подробно о туризме.', 'bolee-podrobno-o-turizme', 0, 106, 2, 'http://ekstrimtur.com/', 1, 11, 'Более подробно о туризме.', '', 1, 1, '', '{"imageurl":"images\\/ekstrimtur.jpg","width":125,"height":125,"alt":"\\u0411\\u043e\\u043b\\u0435\\u0435 \\u043f\\u043e\\u0434\\u0440\\u043e\\u0431\\u043d\\u043e \\u043e \\u0442\\u0443\\u0440\\u0438\\u0437\\u043c\\u0435."}', 0, '', -1, 0, 0, 0, '0000-00-00 00:00:00', '2013-10-17 20:05:00', '2013-11-30 20:05:14', '0000-00-00 00:00:00', '2013-10-18 16:49:54', '*'),
(2, 0, 0, 'Более подробно о бухте Ласпи.', 'bolee-podrobno-o-bukhte-laspi', 0, 71, 2, 'http://crimea.vgorode.ua/news/117753/', 1, 12, 'Более подробно о бухте Ласпи.', '', 1, 2, '', '{"imageurl":"images\\/laspi.jpg","width":125,"height":125,"alt":"\\u0411\\u043e\\u043b\\u0435\\u0435 \\u043f\\u043e\\u0434\\u0440\\u043e\\u0431\\u043d\\u043e \\u043e \\u0431\\u0443\\u0445\\u0442\\u0435 \\u041b\\u0430\\u0441\\u043f\\u0438."}', 0, '', -1, 0, 0, 0, '0000-00-00 00:00:00', '2013-10-17 20:17:23', '2013-11-30 20:17:26', '0000-00-00 00:00:00', '2013-10-18 17:15:50', '*');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_categories`
--

CREATE TABLE IF NOT EXISTS `diyk8_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `diyk8_categories`
--

INSERT INTO `diyk8_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', -2, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:27:35', 0, '0000-00-00 00:00:00', 0, '*'),
...
(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', -2, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:28:33', 0, '0000-00-00 00:00:00', 0, '*'),
...
(8, 35, 1, 13, 14, 1, 'programirovanie', 'com_content', 'Програмирование', 'programirovanie', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"_:blog","image":""}', '', '', '{"author":"","robots":""}', 42, '2013-10-18 13:57:05', 42, '2013-10-18 16:29:49', 0, '*'),
(9, 36, 1, 15, 16, 1, 'krym-bukhta-laspi', 'com_content', 'Крым. Бухта Ласпи.', 'krym-bukhta-laspi', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"_:blog","image":""}', '', '', '{"author":"","robots":""}', 42, '2013-10-18 14:01:09', 42, '2013-10-19 13:39:13', 0, '*'),
(10, 37, 1, 17, 18, 1, 'turizm', 'com_content', 'Туризм', 'turizm', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"_:blog","image":""}', '', '', '{"author":"","robots":""}', 42, '2013-10-18 14:05:11', 42, '2013-10-19 13:37:34', 0, '*'),
(11, 51, 1, 19, 20, 1, 'ssylki', 'com_banners', 'Ссылка туризм', 'ssylki', '', '<h1 style="text-align: center;"><strong>Более подробно о туризме.</strong></h1>', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"images\\/ekstrimtur.jpg"}', '', '', '{"author":"","robots":""}', 42, '2013-10-18 16:55:11', 42, '2013-10-19 14:01:31', 0, '*'),
(12, 52, 1, 21, 22, 1, 'ssylka2', 'com_banners', 'Ссылка ласпи.', 'ssylka2', '', '<h1 style="text-align: center;"><strong>Более подробно о бухте Ласпи.</strong></h1>', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"images\\/laspi.jpg"}', '', '', '{"author":"","robots":""}', 42, '2013-10-18 17:19:53', 42, '2013-10-19 14:02:41', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_contact_details`
--

CREATE TABLE IF NOT EXISTS `diyk8_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `diyk8_content`
--

CREATE TABLE IF NOT EXISTS `diyk8_content` (
...
--
-- Структура таблицы `diyk8_content_rating`
--

CREATE TABLE IF NOT EXISTS `diyk8_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `diyk8_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `diyk8_core_log_searches` (
...
--
-- Структура таблицы `diyk8_djmediatools`
--

CREATE TABLE IF NOT EXISTS `diyk8_djmediatools` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `diyk8_djmediatools`
--

INSERT INTO `diyk8_djmediatools` (`id`, `catid`, `title`, `alias`, `image`, `description`, `published`, `publish_up`, `publish_down`, `checked_out`, `checked_out_time`, `ordering`, `params`) VALUES
(1, 1, 'фото1', 'albom1', 'images/sampledata/parks/landscape/800px_cradle_mountain_seen_from_barn_bluff.jpg', '', 1, '2013-10-18 18:51:02', '2014-01-17 18:51:04', 0, '0000-00-00 00:00:00', 1, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","video_link":""}'),
(2, 1, 'фото2', 'foto2', 'images/sampledata/parks/landscape/800px_ormiston_pound.jpg', '', 1, '2013-10-18 18:52:00', '2014-02-21 18:52:16', 0, '0000-00-00 00:00:00', 2, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","video_link":""}'),
(3, 1, 'фото3', 'foto3', 'images/sampledata/parks/animals/180px_koala_ag1.jpg', '', 1, '2013-10-18 18:52:49', '2014-01-24 18:52:51', 0, '0000-00-00 00:00:00', 3, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","video_link":""}'),
(4, 1, 'фото4', 'foto4', 'images/priroda/pr1.jpg', '', 1, '2013-10-18 19:08:00', '2013-12-27 19:08:02', 0, '0000-00-00 00:00:00', 4, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","video_link":""}'),
(5, 1, 'фото5', 'foto5', 'images/priroda/pr2.jpg', '', 1, '2013-10-18 19:08:38', '2013-12-20 19:08:40', 0, '0000-00-00 00:00:00', 5, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","video_link":""}'),
(6, 1, 'фото6', 'foto6', 'images/priroda/pr3.jpg', '', 1, '2013-10-18 19:09:18', '2013-12-20 19:09:21', 0, '0000-00-00 00:00:00', 6, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","video_link":""}'),
(7, 1, 'фото7', 'foto7', 'images/priroda/pr4.jpg', '', 1, '2013-10-19 19:09:45', '2013-12-20 19:09:47', 0, '0000-00-00 00:00:00', 7, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","video_link":""}'),
(8, 1, 'фото8', 'foto8', 'images/priroda/pr5.jpg', '', 1, '2013-10-18 19:10:14', '2014-01-31 19:10:17', 0, '0000-00-00 00:00:00', 8, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","video_link":""}'),
(9, 1, 'фото9', 'foto9', 'images/priroda/pr6.jpg', '', 1, '2013-10-18 19:10:40', '2014-01-25 19:10:44', 0, '0000-00-00 00:00:00', 9, '{"link_type":"","link_menu":"101","link_url":"","link_article":"","video_link":""}');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_djmediatools_categories`
--

CREATE TABLE IF NOT EXISTS `diyk8_djmediatools_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `diyk8_extensions`
--

INSERT INTO `diyk8_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(10004, 'Календарь', 'module', 'mod_blog_calendar', '', 0, 1, 0, 0, '{"legacy":false,"name":"\\u041a\\u0430\\u043b\\u0435\\u043d\\u0434\\u0430\\u0440\\u044c","type":"module","creationDate":"2012","author":"Juan Padial","copyright":"","authorEmail":"joomlacalendar@ya.ru","authorUrl":"http:\\/\\/joomlacalendar.ru\\/","version":"1.6.5a","description":"\\n\\t<p>\\u041a\\u0430\\u043b\\u0435\\u043d\\u0434\\u0430\\u0440\\u044c, \\u043a\\u043e\\u0442\\u043e\\u0440\\u044b\\u0439 \\u043e\\u0442\\u043e\\u0431\\u0440\\u0430\\u0436\\u0430\\u0435\\u0442 \\u043d\\u043e\\u0432\\u043e\\u0441\\u0442\\u0438 \\u043d\\u0430 \\u0441\\u0430\\u0439\\u0442\\u0435 \\u043f\\u043e \\u043e\\u043f\\u0440\\u0435\\u0434\\u0435\\u043b\\u0435\\u043d\\u043d\\u044b\\u043c \\u0434\\u043d\\u044f\\u043c. \\n\\t<\\/p>","group":""}', '{"show_what":"0","show_list_years":"1","show_list_months":"1","show_list_articles":"1","show_list_sublevels":"1","cal_start_date":"","cal_start_day":"1","cal_length_days":"2","use_article_date":"yes","associatedItemid":"","cbintegration":"0","cache":"1","cache_time":"900","moduleclass_sfx":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10005, 'blog_calendar', 'component', 'com_blog_calendar', '', 1, 1, 0, 0, '{"legacy":false,"name":"Blog_Calendar","type":"component","creationDate":"2012","author":"Juan Padial","copyright":"joomlacalendar.ru","authorEmail":"joomlacalendar@ya.ru","authorUrl":"http:\\/\\/joomlacalendar.ru\\/","version":"1.6.5a","description":"<p>\\n  \\u041a\\u0430\\u043b\\u0435\\u043d\\u0434\\u0430\\u0440\\u044c, \\u043a\\u043e\\u0442\\u043e\\u0440\\u044b\\u0439 \\u043e\\u0442\\u043e\\u0431\\u0440\\u0430\\u0436\\u0430\\u0435\\u0442 \\u043d\\u043e\\u0432\\u043e\\u0441\\u0442\\u0438 \\u043d\\u0430 \\u0441\\u0430\\u0439\\u0442\\u0435 \\u043f\\u043e \\u043e\\u043f\\u0440\\u0435\\u0434\\u0435\\u043b\\u0435\\u043d\\u043d\\u044b\\u043c \\u0434\\u043d\\u044f\\u043c. \\n\\t\\t\\t\\t<\\/p>\\n  ","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10006, 'DJ-MediaTools Album', 'module', 'mod_djmediatools', '', 0, 1, 0, 0, '{"legacy":false,"name":"DJ-MediaTools Album","type":"module","creationDate":"June 2012","author":"DJ-Extensions.com","copyright":"Copyright (C) 2012 DJ-Extensions.com, All rights reserved.","authorEmail":"contact@dj-extensions.com","authorUrl":"http:\\/\\/dj-extensions.com","version":"1.1.0","description":"Displays DJ-MediaTools Album in module position.","group":""}', '{"catid":"","layout":"","slider_type":"","desc_effect":"","sort_by":"","link_image":"","image_width":"","image_height":"","resizing":"","thumb_width":"","thumb_height":"","visible_images":"","space_between_images":"","max_images":"","show_thumbs":"","tab_indicator":"","tab_width":"","tab_height":"","tab_position":"","show_title":"","show_desc":"","show_readmore":"","readmore_text":"","link_title":"","link_desc":"","limit_desc":"","autoplay":"","pause_autoplay":"","show_buttons":"","show_arrows":"","show_custom_nav":"","effect":"","effect_type":"","duration":"","delay":"","preload":"","desc_position":"","desc_width":"","desc_bottom":"","desc_horizontal":"","left_arrow":"","right_arrow":"","play_button":"","pause_button":"","arrows_top":"","arrows_horizontal":"","custom_nav_pos":"","custom_nav_align":"","loader_position":"","cache":"1","cache_time":"900"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10007, 'plg_content_djmediatools', 'plugin', 'djmediatools', 'content', 0, 1, 1, 0, '{"legacy":false,"name":"plg_content_djmediatools","type":"plugin","creationDate":"June 2012","author":"DJ-Extensions.com","copyright":"Copyright (C) 2012 DJ-Extensions.com, All rights reserved.","authorEmail":"contact@dj-extensions.com","authorUrl":"http:\\/\\/dj-extensions.com","version":"1.1.0","description":"PLG_CONTENT_DJMEDIATOOLS_DESCRIPTION","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10008, 'plg_editors-xtd_djmediatools', 'plugin', 'djmediatools', 'editors-xtd', 0, 1, 1, 0, '{"legacy":false,"name":"plg_editors-xtd_djmediatools","type":"plugin","creationDate":"June 2012","author":"DJ-Extensions.com","copyright":"Copyright (C) 2012 DJ-Extensions.com, All rights reserved.","authorEmail":"contact@dj-extensions.com","authorUrl":"http:\\/\\/dj-extensions.com","version":"1.1.0","description":"plg_editors-xtd_djmediatools","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10009, 'plg_djmediatools_content', 'plugin', 'content', 'djmediatools', 0, 1, 1, 0, '{"legacy":false,"name":"plg_djmediatools_content","type":"plugin","creationDate":"September 2012","author":"DJ-Extensions.com","copyright":"Copyright (C) 2012 DJ-Extensions.com, All rights reserved.","authorEmail":"contact@dj-extensions.com","authorUrl":"http:\\/\\/dj-extensions.com","version":"1.1.0","description":"plg_djmediatools_content","group":""}', '{"plg_content_type":"featured","plg_content_maxlevel":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10010, 'plg_djmediatools_folder', 'plugin', 'folder', 'djmediatools', 0, 1, 1, 0, '{"legacy":false,"name":"plg_djmediatools_folder","type":"plugin","creationDate":"September 2012","author":"DJ-Extensions.com","copyright":"Copyright (C) 2012 DJ-Extensions.com, All rights reserved.","authorEmail":"contact@dj-extensions.com","authorUrl":"http:\\/\\/dj-extensions.com","version":"1.1.0","description":"plg_djmediatools_folder","group":""}', '{"plg_folder_path":"","plg_folder_link":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10011, 'plg_djmediatools_djcatalog2', 'plugin', 'djcatalog2', 'djmediatools', 0, 1, 1, 0, '{"legacy":false,"name":"plg_djmediatools_djcatalog2","type":"plugin","creationDate":"September 2012","author":"DJ-Extensions.com","copyright":"Copyright (C) 2012 DJ-Extensions.com, All rights reserved.","authorEmail":"contact@dj-extensions.com","authorUrl":"http:\\/\\/dj-extensions.com","version":"1.1.0","description":"plg_djmediatools_djcatalog2","group":""}', '{"plg_catalog2_catid":"0","plg_catalog2_featured_only":"0","plg_catalog2_featured_first":"0","plg_catalog2_orderby":"0","plg_catalog2_orderdir":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10012, 'plg_djmediatools_djclassifieds', 'plugin', 'djclassifieds', 'djmediatools', 0, 1, 1, 0, '{"legacy":false,"name":"plg_djmediatools_djclassifieds","type":"plugin","creationDate":"September 2012","author":"DJ-Extensions.com","copyright":"Copyright (C) 2012 DJ-Extensions.com, All rights reserved.","authorEmail":"contact@dj-extensions.com","authorUrl":"http:\\/\\/dj-extensions.com","version":"1.1.0","description":"plg_djmediatools_djclassifieds","group":""}', '{"plg_classifieds_catid":"0","plg_classifieds_items_ord":"0","plg_classifieds_only_promoted":"0","plg_classifieds_items_ids":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10013, 'com_djmediatools', 'component', 'com_djmediatools', '', 1, 1, 0, 0, '{"legacy":false,"name":"com_djmediatools","type":"component","creationDate":"September 2012","author":"DJ-Extensions.com","copyright":"Copyright (C) 2012 DJ-Extensions.com, All rights reserved.","authorEmail":"contact@dj-extensions.com","authorUrl":"http:\\/\\/dj-extensions.com","version":"1.1.1","description":"DJ-MediaTools component","group":""}', '{"show_cat_titles":"2","cwidth":"200","cheight":"200","cresizing":"crop","cquality":"80","show_subcategories":"after","layout":"_:slideshow","slider_type":"left","desc_effect":"fade","sort_by":"1","link_image":"1","lightbox":"picbox","image_width":"700","image_height":"450","resizing":"crop","quality":"90","thumb_width":"","thumb_height":"","visible_images":"3","space_between_images":"1","max_images":"50","show_thumbs":"1","tab_indicator":"2","tab_width":"200","tab_height":"50","tab_position":"right","show_title":"1","show_desc":"1","show_readmore":"0","readmore_text":"","link_title":"1","link_desc":"0","limit_desc":"","autoplay":"1","pause_autoplay":"1","show_buttons":"2","show_arrows":"2","show_custom_nav":"1","effect":"Expo","effect_type":"0","duration":"","delay":"","preload":"","desc_position":"over","desc_width":"","desc_bottom":"0","desc_horizontal":"0","left_arrow":"","right_arrow":"","play_button":"","pause_button":"","arrows_top":"50","arrows_horizontal":"10","custom_nav_pos":"below","custom_nav_align":"center","loader_position":"tl"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10014, 'dj-mediatools', 'package', 'pkg_dj-mediatools', '', 0, 1, 1, 0, '{"legacy":false,"name":"DJ-MediaTools Package","type":"package","creationDate":"November 2012","author":"DJ-Extensions.com","copyright":"Copyright (C) 2012 DJ-Extensions.com, All rights reserved.","authorEmail":"contact@dj-extensions.com","authorUrl":"http:\\/\\/dj-extensions.com","version":"1.1.1","description":"\\n\\t\\t<style> #right-text {font-family:Arial, Helvetica, sans-serif;\\tfont-size:11px;\\t} #right-text a:link, #right-text a:visited {color:#4991c1;font-weight:bold; font-size: 13px;} #right-text a:hover {text-decoration:underline;}\\t#right-text h2 {color:#fa9539;text-transform:uppercase;\\tfont-size:16px;\\tpadding:0;\\tmargin:2px 0;}\\t#right-text p {padding:0;margin:4px 0;}\\t#left-logo {float:left;width:270px;height:120px;display:block;} #left-logo img {margin: 40px 20px;} #right-text {float:left;width:400px;}<\\/style>\\n\\t\\n\\t\\t<div id=\\"left-logo\\">\\n\\t\\t\\t<a target=\\"_blank\\" href=\\"http:\\/\\/dj-extensions.com\\"><img src=\\"http:\\/\\/new.dj-extensions.com\\/templates\\/dj-extensions\\/images\\/logo.png\\" alt=\\"DJ-Extensions.com\\" \\/><\\/a>\\n\\t\\t<\\/div>\\n\\t\\t\\n\\t\\t<div id=\\"right-text\\">\\n\\t\\t\\t<h2>Thank you for installing DJ-MediaTools!<\\/h2>\\n\\t\\t\\t<p>The DJ-MediaTools extension allows you to display albums containing custom items or any different content from other 3rd party extensions on different layouts including gallery grid, slideshow based on our new script or slider based on DJ-ImageSlider and more up to 7 different layouts.<\\/p>\\n\\t\\t\\t<p>If you want to learn how to use DJ-MediaTools please read <a target=\\"_blank\\" href=\\"http:\\/\\/dj-extensions.com\\/documentation\\">Documentation<\\/a> and search our <a target=\\"_blank\\" href=\\"http:\\/\\/dj-extensions.com\\/forum\\">Support Forum<\\/a><br \\/><br \\/>Check out our other extensions at <a target=\\"_blank\\" href=\\"http:\\/\\/dj-extensions.com\\">DJ-Extensions.com<\\/a><\\/p>\\n\\t\\t<\\/div>\\n\\t\\n\\t\\t","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10022, 'bevzatemplate', 'template', 'bevzatemplate', '', 0, 1, 1, 0, '{"legacy":false,"name":"bevzatemplate","type":"template","creationDate":"25 November 2009","author":"Bevza Sergey","copyright":"Copyright (C) 2005 - 2012 Open Source Matters, Inc. All rights reserved.","authorEmail":"a.radtke@derauftritt.de","authorUrl":"http:\\/\\/www.der-auftritt.de","version":"2.5.0","description":"TPL_BEEZ2_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, -1),
(10023, 'bevzatest2', 'template', 'bevzatest2', '', 0, 1, 1, 0, '{"legacy":false,"name":"bevzatest2","type":"template","creationDate":"25 November 2009","author":"Angie Radtke","copyright":"Copyright (C) 2005 - 2013 Open Source Matters, Inc. All rights reserved.","authorEmail":"a.radtke@derauftritt.de","authorUrl":"http:\\/\\/www.der-auftritt.de","version":"2.5.0","description":"TPL_BEEZ2_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, -1),
(10024, 'bevzatest3', 'template', 'bevzatest3', '', 0, 1, 1, 0, '{"legacy":false,"name":"bevzatest3","type":"template","creationDate":"26 october 2013","author":"Bevza Sergey","copyright":"Copyright (C) 2005 - 2013 Open Source Matters, Inc. All rights reserved.","authorEmail":"bevza_s@ukr.net","authorUrl":"http:\\/\\/www.der-auftritt.de","version":"2.5.0","description":"TPL_BEEZ2_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, -1),
(10026, 'geekhub1', 'template', 'geekhub1', '', 0, 1, 1, 0, '{"legacy":false,"name":"geekhub1","type":"template","creationDate":"29 october 2013","author":"bevza sergey","copyright":"Copyright (C) 2005 - 2013 Open Source Matters, Inc. All rights reserved.","authorEmail":"a.radtke@derauftritt.de","authorUrl":"http:\\/\\/www.der-auftritt.de","version":"2.5.0","description":"TPL_BEEZ2_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, -1),
(10028, 'mod_helloworld', 'module', 'mod_helloworld', '', 0, 1, 0, 0, 'false', '[]', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10030, '', 'module', 'mod_mppopup', '', 0, 1, 0, 0, '{"legacy":false,"name":"","type":"module","creationDate":"Unknown","author":"Unknown","copyright":"","authorEmail":"","authorUrl":"","version":"","description":"","group":""}', '[]', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10032, 'mod_homework4', 'module', 'mod_homework4', '', 0, 1, 0, 0, '{"legacy":false,"name":"mod_homework4","type":"module","creationDate":"November 2013","author":"Bevza_Sergey","copyright":"","authorEmail":"bevza_s@ukr.net","authorUrl":"","version":"0.0.1","description":"MOD_HOMEWORK4_XML_DESCRIPTION","group":""}', '{"myintegeralue":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10040, 'com_homework6', 'component', 'com_homework6', '', 1, 1, 0, 0, '{"legacy":false,"name":"com_homework6","type":"component","creationDate":"2013-11-26","author":"sergey","copyright":"\\u00a9 2013. \\u0412\\u0441\\u0435 \\u043f\\u0440\\u0430\\u0432\\u0430 \\u0437\\u0430\\u0449\\u0438\\u0449\\u0435\\u043d\\u044b.","authorEmail":"bevza@ukr.net","authorUrl":"http:\\/\\/","version":"1.0.0","description":"homework6","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_finder_filters`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_filters` (
...
--
-- Структура таблицы `diyk8_finder_links`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links` (
...
--
-- Структура таблицы `diyk8_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms0` (
...
--
-- Структура таблицы `diyk8_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `diyk8_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `diyk8_finder_taxonomy`
--

INSERT INTO `diyk8_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `diyk8_finder_terms`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_terms` (
...
--
-- Структура таблицы `diyk8_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Дамп данных таблицы `diyk8_finder_terms_common`
--

INSERT INTO `diyk8_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `diyk8_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `diyk8_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `diyk8_finder_types`
--

CREATE TABLE IF NOT EXISTS `diyk8_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `diyk8_homework6_liststudent`
--

CREATE TABLE IF NOT EXISTS `diyk8_homework6_liststudent` (
...
--
-- Дамп данных таблицы `diyk8_homework6_liststudent`
--

INSERT INTO `diyk8_homework6_liststudent` (`id`, `ordering`, `state`, `checked_out`, `checked_out_time`, `created_by`, `namy`, `info`, `age`, `floor`, `group`, `ball`, `number`, `foto`) VALUES
(1, 1, 1, 0, '0000-00-00 00:00:00', 42, 'Сергей Бевза', 'студент', '35', 'мужской', 'СКЗП-26', '4,8', 'СКЗП123456789', 'images/geekhub.jpg'),
(2, 2, 1, 0, '0000-00-00 00:00:00', 42, 'Иванов Иван', 'студент', '30', 'мужской', 'СКЗП-26', '4.7', 'СКЗП234567891', 'images/ekstrimtur.jpg'),
(3, 3, 1, 0, '0000-00-00 00:00:00', 42, 'Петров Петр', 'студент, староста группы.', '32', 'мужской', 'СКЗП-26', '5', 'СКЗП345678912', 'images/foros_zerk.jpg'),
(4, 4, 1, 0, '0000-00-00 00:00:00', 42, 'Вероника Шевченко', 'студент', '27', 'женский', 'СКЗП-26', '4,9', 'СКЗП4567891234', 'images/foros_zerk_1.jpg'),
(5, 5, 1, 0, '0000-00-00 00:00:00', 42, 'Анастасия Тарасенко', 'координатор', '29', 'женский', 'деканат', '-', '-', 'images/hersones_1.jpg');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_languages`
--

CREATE TABLE IF NOT EXISTS `diyk8_languages` (
...
--
-- Дамп данных таблицы `diyk8_languages`
--

INSERT INTO `diyk8_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_liststudent_mylist`
--

CREATE TABLE IF NOT EXISTS `diyk8_liststudent_mylist` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `diyk8_liststudent_mylist`
--

INSERT INTO `diyk8_liststudent_mylist` (`id`, `asset_id`, `ordering`, `state`, `checked_out`, `checked_out_time`, `created_by`, `name`, `info`, `year`, `floor`, `group`, `ball`, `number`, `foto`) VALUES
(1, 65, 1, 1, 0, '0000-00-00 00:00:00', 42, 'ывуа', 'ыакерп', 'вамке', 'купне', 'екпри', 'керн', 'рпнеор', '<p><img src="images/ekstrimtur.jpg" border="0" alt="" /></p>'),
(2, 66, 2, 1, 0, '0000-00-00 00:00:00', 42, 'цук4ке', 'куере7нкошг', 'кнео', 'ке6ног', '375ог', '6н5ог', '7гно', '<p><img src="images/geekhub.jpg" border="0" alt="" /></p>');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_menu`
--

CREATE TABLE IF NOT EXISTS `diyk8_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `diyk8_menu`
--

INSERT INTO `diyk8_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(101, 'menyu', 'Статьи по интересам.', 'home', '', 'home', 'index.php?option=com_content&view=categories&id=0', 'component', 1, 1, 1, 22, 0, 42, '2013-11-26 14:02:51', 0, 1, '', 0, '{"show_base_description":"0","categories_description":"","maxLevelcat":"","show_empty_categories_cat":"","show_subcat_desc_cat":"","show_cat_num_articles_cat":"","show_category_title":"1","show_description":"1","show_description_image":"1","maxLevel":"-1","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","num_leading_articles":"1","num_intro_articles":"3","num_columns":"1","num_links":"0","multi_column_order":"0","show_subcategory_content":"","orderby_pri":"","orderby_sec":"front","order_date":"","show_pagination":"2","show_pagination_results":"1","show_pagination_limit":"","filter_field":"","show_headings":"1","list_show_date":"","date_format":"","list_show_hits":"","list_show_author":"","display_num":"10","show_title":"1","link_titles":"0","show_intro":"1","show_category":"0","link_category":"0","show_parent_category":"1","link_parent_category":"1","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_vote":"0","show_readmore":"","show_readmore_title":"","show_icons":"0","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"1","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":1,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 29, 30, 1, '*', 0),
(102, 'menyu', 'Бухта Ласпи.', 'katalog-statej', '', 'katalog-statej', 'index.php?option=com_content&view=article&id=5', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 45, 46, 0, '*', 0),
(103, 'menyu', 'Туризм.', 'turizm', '', 'turizm', 'index.php?option=com_content&view=category&layout=blog&id=10', 'component', 1, 1, 1, 22, 0, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"layout_type":"blog","show_category_heading_title_text":"","show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","page_subheading":"","num_leading_articles":"","num_intro_articles":"","num_columns":"","num_links":"","multi_column_order":"0","show_subcategory_content":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"","show_pagination_results":"","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"0","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 43, 44, 0, '*', 0),
(104, 'main', 'Календарь', 'kalendar', '', 'kalendar', 'index.php?option=com_blog_calendar', 'component', 0, 1, 1, 10005, 0, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 47, 50, 0, '', 1),
(105, 'main', 'Редактировать CSS', 'redaktirovat-css', '', 'kalendar/redaktirovat-css', 'index.php?option=com_blog_calendar&task=edit_css', 'component', 0, 104, 2, 10005, 0, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '', 48, 49, 0, '', 1),
(106, 'main', 'COM_DJMEDIATOOLS', 'com-djmediatools', '', 'com-djmediatools', 'index.php?option=com_djmediatools', 'component', 0, 1, 1, 10013, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_djmediatools/assets/icon-16-djmediatools.png', 0, '', 51, 56, 0, '', 1),
(107, 'main', 'COM_DJMEDIATOOLS_SLIDES', 'com-djmediatools-slides', '', 'com-djmediatools/com-djmediatools-slides', 'index.php?option=com_djmediatools&view=items', 'component', 0, 106, 2, 10013, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_djmediatools/assets/icon-16-menu-slides.png', 0, '', 52, 53, 0, '', 1),
(108, 'main', 'COM_DJMEDIATOOLS_CATEGORIES', 'com-djmediatools-categories', '', 'com-djmediatools/com-djmediatools-categories', 'index.php?option=com_djmediatools&view=categories', 'component', 0, 106, 2, 10013, 0, 0, '0000-00-00 00:00:00', 0, 1, 'class:category', 0, '', 54, 55, 0, '', 1),
(132, 'menyu', 'Список студентов', 'spisok-studentov', '', 'spisok-studentov', 'index.php?option=com_homework6&view=lists', 'component', 1, 1, 1, 10040, 0, 42, '2013-11-27 09:26:28', 0, 1, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 59, 60, 0, '*', 0),
(135, 'main', 'COM_HOMEWORK6', 'com-homework6', '', 'com-homework6', 'index.php?option=com_homework6', 'component', 0, 1, 1, 10040, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_homework6/assets/images/s_com_homework6.png', 0, '', 61, 64, 0, '', 1),
(136, 'main', 'COM_HOMEWORK6_TITLE_LISTS', 'com-homework6-title-lists', '', 'com-homework6/com-homework6-title-lists', 'index.php?option=com_homework6&view=lists', 'component', 0, 135, 2, 10040, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_homework6/assets/images/s_lists.png', 0, '', 62, 63, 0, '', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_menu_types`
--

CREATE TABLE IF NOT EXISTS `diyk8_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `diyk8_menu_types`
--

INSERT INTO `diyk8_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'menyu', 'Меню.', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_messages`
--

CREATE TABLE IF NOT EXISTS `diyk8_messages` (
...
--
-- Структура таблицы `diyk8_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `diyk8_messages_cfg` (
...
--
-- Структура таблицы `diyk8_modules`
--

CREATE TABLE IF NOT EXISTS `diyk8_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `diyk8_modules`
--

INSERT INTO `diyk8_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Main Menu', '', '', 1, 'position-7', 42, '2013-11-26 16:39:14', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"menyu","startLevel":"0","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
...
(17, 'Breadcrumbs', '', '', 2, 'position-2', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_breadcrumbs', 1, 1, '{"showHere":"1","showHome":"1","homeText":"Home","showLast":"1","separator":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(79, 'Multilanguage status', '', '', 1, 'status', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_multilangstatus', 3, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(86, 'Joomla Version', '', '', 1, 'footer', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_version', 3, 1, '{"format":"short","product":"1","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 1, '*'),
(87, 'Баннер туризм.', '', '', 1, 'position-5', 0, '0000-00-00 00:00:00', '2013-10-17 20:09:59', '2013-11-30 20:10:01', 0, 'mod_banners', 1, 0, '{"target":"1","count":"5","cid":"0","catid":["11"],"tag_search":"0","ordering":"0","header_text":"\\u0411\\u043e\\u043b\\u0435\\u0435 \\u043f\\u043e\\u0434\\u0440\\u043e\\u0431\\u043d\\u043e \\u043e \\u0442\\u0443\\u0440\\u0438\\u0437\\u043c\\u0435.","footer_text":"\\u043d\\u0430\\u0436\\u043c\\u0438 \\u0437\\u0434\\u0435\\u0441\\u044c.","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900"}', 0, '*'),
(88, 'Баннер ласпи.', '', '', 2, 'position-3', 0, '0000-00-00 00:00:00', '2013-10-17 20:14:57', '2013-11-30 20:15:00', 1, 'mod_banners', 1, 0, '{"target":"1","count":"5","cid":"0","catid":["12"],"tag_search":"0","ordering":"0","header_text":"\\u0411\\u043e\\u043b\\u0435\\u0435 \\u043f\\u043e\\u0434\\u0440\\u043e\\u0431\\u043d\\u043e \\u043e \\u041b\\u0430\\u0441\\u043f\\u0438.","footer_text":"\\u043d\\u0430\\u0436\\u043c\\u0438 \\u0437\\u0434\\u0435\\u0441\\u044c.","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900"}', 0, '*'),
(89, 'Улыбнитесь.', '', '', 1, 'position-3', 0, '0000-00-00 00:00:00', '2013-10-17 20:26:16', '2013-11-30 20:26:18', 1, 'mod_random_image', 1, 1, '{"type":"jpg","folder":"\\/var\\/www\\/joomla\\/images\\/smex","link":"","width":"225","height":"225","layout":"_:default","moduleclass_sfx":"","cache":"0"}', 0, '*'),
(90, 'Программирование', '', '', 1, 'position-14', 0, '0000-00-00 00:00:00', '2013-10-18 17:24:33', '2013-12-31 17:24:36', 0, 'mod_wrapper', 1, 1, '{"url":"http:\\/\\/geekhub.ck.ua\\/","add":"1","scrolling":"auto","width":"98%","height":"300","height_auto":"1","frameborder":"1","target":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(91, 'Календарь', '', '', 1, 'position-6', 0, '0000-00-00 00:00:00', '2013-10-18 18:17:58', '2014-02-20 18:18:00', 1, 'mod_blog_calendar', 1, 1, '{"show_what":"0","show_list_years":"1","show_list_months":"1","show_list_articles":"1","show_list_sublevels":"1","cal_start_date":"","cal_start_day":"1","cal_length_days":"3","use_article_date":"yes","associatedItemid":"","cbintegration":"0","cache":"1","cache_time":"900","moduleclass_sfx":""}', 0, '*'),
(92, 'FOOTER', '', '', 0, 'position-10', 0, '0000-00-00 00:00:00', '2013-10-18 18:28:17', '2013-12-20 18:28:19', 1, 'mod_footer', 1, 1, '{"layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(93, 'DJ-MediaTools Album', '', '', 1, 'position-4', 0, '0000-00-00 00:00:00', '2013-10-18 18:40:08', '2014-02-14 18:40:10', 1, 'mod_djmediatools', 1, 1, '{"catid":"1","layout":"_:slideshow","slider_type":"","desc_effect":"","sort_by":"","link_image":"","lightbox":"picbox","image_width":"200","image_height":"200","resizing":"","thumb_width":"200","thumb_height":"200","visible_images":"","space_between_images":"","max_images":"","show_thumbs":"","tab_indicator":"","tab_width":"","tab_height":"","tab_position":"","show_title":"","show_desc":"","show_readmore":"","readmore_text":"","link_title":"","link_desc":"","limit_desc":"","autoplay":"","pause_autoplay":"","show_buttons":"","show_arrows":"","show_custom_nav":"","effect":"","effect_type":"","duration":"","delay":"","preload":"","desc_position":"over","desc_width":"","desc_bottom":"","desc_horizontal":"","left_arrow":"images\\/sampledata\\/parks\\/landscape\\/120px_pinnacles_western_australia.jpg","right_arrow":"images\\/sampledata\\/parks\\/landscape\\/120px_rainforest_bluemountainsnsw.jpg","play_button":"images\\/sampledata\\/parks\\/landscape\\/180px_ormiston_pound.jpg","pause_button":"images\\/sampledata\\/parks\\/landscape\\/250px_cradle_mountain_seen_from_barn_bluff.jpg","arrows_top":"","arrows_horizontal":"","custom_nav_pos":"","custom_nav_align":"","loader_position":"","moduleclass_sfx":"","cache":"1","cache_time":"900"}', 0, '*'),
(97, 'всплывающее окно', '', '<p>Привет, как дела?</p>', 1, 'pop_up', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_custom', 1, 1, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(98, 'Всплывающее меню', '', '', 1, 'position-1', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_mppopup', 1, 1, '{"width":"","height":""}', 0, '*'),
(99, 'mod_homework4', '', '', 1, 'position-5', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_homework4', 1, 1, '{"mycategory":"9","myintegeralue":"5"}', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_modules_menu`
--

CREATE TABLE IF NOT EXISTS `diyk8_modules_menu` (
...
--
-- Дамп данных таблицы `diyk8_modules_menu`
--

INSERT INTO `diyk8_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `diyk8_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `diyk8_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `diyk8_overrider`
--

CREATE TABLE IF NOT EXISTS `diyk8_overrider` (
...
--
-- Структура таблицы `diyk8_redirect_links`
--

CREATE TABLE IF NOT EXISTS `diyk8_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `diyk8_redirect_links`
--

INSERT INTO `diyk8_redirect_links` (`id`, `old_url`, `new_url`, `referer`, `comment`, `hits`, `published`, `created_date`, `modified_date`) VALUES
(1, 'http://127.0.0.1/joomla/index.php/turizm', 'http://ekstrimtur.com/', '', 'Более подробно о туризме.', 0, -2, '2013-10-18 16:46:02', '0000-00-00 00:00:00'),
(2, 'http://127.0.0.1/joomla/index.php/spisok-studentov1', '', 'http://127.0.0.1/joomla/', '', 1, 0, '2013-11-26 14:27:26', '0000-00-00 00:00:00'),
(3, 'http://127.0.0.1/joomla/index.php/spisok-studentov2', '', 'http://127.0.0.1/joomla/index.php/spisok-studentov2', '', 1, 0, '2013-11-26 14:32:17', '0000-00-00 00:00:00'),
(4, 'http://127.0.0.1/joomla/index.php?Itemid=123', '', 'http://127.0.0.1/joomla/index.php/spisok-studentov2', '', 4, 0, '2013-11-26 14:32:19', '0000-00-00 00:00:00'),
(5, 'http://127.0.0.1/joomla/index.php/spisok-studentov', '', 'http://127.0.0.1/joomla/index.php/spisok-studentov', '', 1, 0, '2013-11-26 15:54:18', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_schemas`
--

CREATE TABLE IF NOT EXISTS `diyk8_schemas` (
...
--
-- Дамп данных таблицы `diyk8_schemas`
--

INSERT INTO `diyk8_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.16'),
(10013, '1.0');
...
--
-- Структура таблицы `diyk8_session`
--

CREATE TABLE IF NOT EXISTS `diyk8_session` (
...
--
-- Дамп данных таблицы `diyk8_session`
--

INSERT INTO `diyk8_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('0da2b84334309ac0301891609eebb9ed', 0, 1, '1385935525', '__default|a:7:{s:22:"session.client.browser";s:102:"Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36";s:15:"session.counter";i:122;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":1:{s:13:"com_homework6";O:8:"stdClass":2:{s:5:"lists";O:8:"stdClass":1:{s:8:"ordercol";s:10:"a.ordering";}s:4:"edit";O:8:"stdClass":1:{s:4:"list";O:8:"stdClass":1:{s:2:"id";s:1:"1";}}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:19:"session.timer.start";i:1385933428;s:18:"session.timer.last";i:1385935524;s:17:"session.timer.now";i:1385935524;}', 0, '', ''),
('2fsh40lorevtklbcrj32rg1ta3', 1, 0, '1385935546', '__default|a:8:{s:15:"session.counter";i:3;s:19:"session.timer.start";i:1385935543;s:18:"session.timer.last";i:1385935545;s:17:"session.timer.now";i:1385935545;s:22:"session.client.browser";s:102:"Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":1:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:2:"42";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:15:"bevza_s@ukr.net";s:8:"password";s:65:"09ff532ffe3c53504203f415bd2cccfb:qdXkYwF2N7gGS4uawNDeeDwVhJmpQ6PO";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-10-12 15:08:52";s:13:"lastvisitDate";s:19:"2013-12-01 17:01:19";s:10:"activation";s:1:"0";s:6:"params";s:92:"{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":6:{s:11:"admin_style";s:0:"";s:14:"admin_language";s:0:"";s:8:"language";s:0:"";s:6:"editor";s:0:"";s:8:"helpsite";s:0:"";s:8:"timezone";s:0:"";}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"b0c66e6dd1dd00242ae7d4bfb6d2ac5a";}', 42, 'admin', '');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_template_styles`
--

CREATE TABLE IF NOT EXISTS `diyk8_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `diyk8_template_styles`
--

INSERT INTO `diyk8_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"1","colourChoice":"highcontrast","boldText":"0"}'),
(6, 'beez5', 0, '0', 'Beez5 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/sampledata\\/fruitshop\\/fruits.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","html5":"0"}'),
(7, 'GeekBevza', 0, '0', 'GeekBevza - По умолчанию', '{"wrapperSmall":"53","wrapperLarge":"72","sitetitle":"","sitedescription":"","navposition":"center","templatecolor":"nature"}'),
(8, 'geek_teleport', 0, '0', 'beez_20 - По умолчанию', '{"wrapperSmall":"53","wrapperLarge":"72","sitetitle":"","sitedescription":"","navposition":"center","templatecolor":"nature"}');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_update_categories`
--

CREATE TABLE IF NOT EXISTS `diyk8_update_categories` (
...
--
-- Структура таблицы `diyk8_update_sites`
--

CREATE TABLE IF NOT EXISTS `diyk8_update_sites` (
...
--
-- Дамп данных таблицы `diyk8_update_sites`
--

INSERT INTO `diyk8_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1385917288),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1385917288),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1385917288),
(4, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1385917288),
(5, 'BlogCalendar Updates', 'extension', '/', 0, 1385217751);

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `diyk8_update_sites_extensions` (
...
--
-- Дамп данных таблицы `diyk8_update_sites_extensions`
--

INSERT INTO `diyk8_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 10003),
(4, 600),
...
--
-- Структура таблицы `diyk8_updates`
--

CREATE TABLE IF NOT EXISTS `diyk8_updates` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Available Updates' AUTO_INCREMENT=91 ;

--
-- Дамп данных таблицы `diyk8_updates`
--

INSERT INTO `diyk8_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(8, 3, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(9, 3, 0, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '2.5.15.1', '', 'http://update.joomla.org/language/details/it-IT_details.xml', ''),
...
(16, 3, 0, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/lv-LV_details.xml', ''),
...
(19, 3, 0, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/nl-BE_details.xml', ''),
(20, 3, 0, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/mk-MK_details.xml', ''),
(21, 3, 0, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/ja-JP_details.xml', ''),
(22, 3, 0, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/sr-YU_details.xml', ''),
(23, 3, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(24, 3, 0, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/de-DE_details.xml', ''),
...
(34, 3, 0, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/pl-PL_details.xml', ''),
...
(54, 3, 0, 0, 'Tamil India', '', 'pkg_ta-IN', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/ta-IN_details.xml', ''),
...
(62, 3, 0, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/sw-KE_details.xml', ''),
(63, 3, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(64, 4, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(65, 3, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(66, 4, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(67, 3, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(68, 4, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(69, 3, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(70, 3, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(71, 4, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(72, 4, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(73, 3, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(74, 3, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(75, 4, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(76, 4, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(77, 3, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(78, 3, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(79, 4, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(80, 4, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(81, 3, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(82, 3, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(83, 4, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(84, 4, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(85, 3, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(86, 3, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(87, 3, 0, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/fa-IR_details.xml', ''),
(88, 4, 0, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/fr-FR_details.xml', ''),
(89, 4, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(90, 4, 0, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/fa-IR_details.xml', '');

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_user_notes`
--

CREATE TABLE IF NOT EXISTS `diyk8_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `diyk8_user_profiles`
--

CREATE TABLE IF NOT EXISTS `diyk8_user_profiles` (
...
--
-- Структура таблицы `diyk8_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `diyk8_user_usergroup_map` (
...
--
-- Дамп данных таблицы `diyk8_user_usergroup_map`
--

INSERT INTO `diyk8_user_usergroup_map` (`user_id`, `group_id`) VALUES
(42, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_usergroups`
--

CREATE TABLE IF NOT EXISTS `diyk8_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `diyk8_usergroups`
--

INSERT INTO `diyk8_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Структура таблицы `diyk8_users`
--

CREATE TABLE IF NOT EXISTS `diyk8_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `diyk8_users`
--

INSERT INTO `diyk8_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(42, 'Super User', 'admin', 'bevza_s@ukr.net', '09ff532ffe3c53504203f415bd2cccfb:qdXkYwF2N7gGS4uawNDeeDwVhJmpQ6PO', 'deprecated', 0, 1, '2013-10-12 15:08:52', '2013-12-01 22:05:45', '0', '{"admin_style":"","admin_language":"","language":"","editor":"","helpsite":"","timezone":""}', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `diyk8_viewlevels`
--

CREATE TABLE IF NOT EXISTS `diyk8_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Дамп данных таблицы `diyk8_viewlevels`
--

INSERT INTO `diyk8_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Структура таблицы `diyk8_weblinks`
--

CREATE TABLE IF NOT EXISTS `diyk8_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
