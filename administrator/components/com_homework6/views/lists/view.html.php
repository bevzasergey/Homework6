...
/**
 * View class for a list of Homework6.
 */
class Homework6ViewLists extends JView
{
	protected $items;
	...
	public function display($tpl = null)
	{
        ...
        Homework6Helper::addSubmenu($view);
	...
	protected function addToolbar()
	{
		...
		$canDo	= Homework6Helper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_HOMEWORK6_TITLE_LISTS'), 'lists.png');
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_homework6');
		}
