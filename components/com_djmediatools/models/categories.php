<?php
/**
 * @version $Id: categories.php 4 2012-12-06 13:48:32Z szymon $
...
class DJMediatoolsModelCategories extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->from('#__djmediatools_categories AS a');
		
		// Join over the categories.
		$query->select('c.title AS parent_title');
		$query->join('LEFT', '#__djmediatools_categories AS c ON c.id = a.parent_id');
